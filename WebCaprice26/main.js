...
// ==========================================================================
// 14. STUDENT PORTAL SIMULATOR
// ==========================================================================
function initStudentPortal() {
  const loginBtn = document.getElementById("btn-fingerprint-login");
  const loginCard = document.getElementById("portal-login-card");
  const dashPanel = document.getElementById("portal-dashboard-panel");

  if (!loginBtn || !dashPanel) return;
